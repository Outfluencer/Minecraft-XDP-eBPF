...
Currently the filter is only available for ipv4 and supports 1.8 - 1.21.11.  
...
# Install (Linux)
Install the libs, that you can see in the `/.github/workflow/rust.yml` file and run `./build.sh`  
